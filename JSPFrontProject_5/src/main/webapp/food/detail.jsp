			...
			<table class="table">
				<tr>
					<td width=40% class="text-center" rowspan="8">
						<img src="${vo.poster }" style="width:360px;height:300px"
						class="img-rounded">
					</td>
					<td colspan="2">
				...
				<tr>
					<th width="10%" style="color:gray">가격</th>
		...
		<div class="row text-center" style="margin-top:10px"">
			...
			<c:if test="${rcount != 0 }">
				<table class="table">
					...
					<tr>
						<td><pre style="white-space:pre-wrap;background:white;border:none"></pre></td>
					</tr>
				</table>
			</c:if>
		</div>
