    ...
    <section class="archive-area section_padding_80">
        <div class="container">
            <div class="row">
	           <table class="table">
	           	<tr>
	           		<th width="20%" class="text-centner danger">공지 유형</th>
	           		<td colspan="3">
	           			<c:choose>
	           	...
	           	<tr>
	           		<th width="20%" class="text-centner danger">번호</th>
	           		<td width="30%" class="text-centner">${vo.no }</td>
	           		<th width="20%" class="text-centner danger">작성일</th>
	           		<td width="30%" class="text-centner">${vo.dbday }</td>
	           	</tr>
	           	<tr>
	           		<th width="20%" class="text-centner danger">작성자</th>
	           		<td width="30%" class="text-centner">${vo.name }</td>
	           		<th width="20%" class="text-centner danger">조회수</th>
	           		<td width="30%" class="text-centner">${vo.hit }</td>
	           	</tr>
	           	<tr>
	           		<th width="20%" class="text-centner danger">제목</th>
	           	...
	           	<tr>
	           		<td colspan="4" class="text-right">
	           			<a class="btn btn-sm btn-danger" href="../notice/user_list.do">목록</a>
	           		</td>
	           	</tr>
	           </table>
            </div>
